...
$(function () {
    function displayTable() {
        $('#info').fadeOut(50, function () {
            ...
            <tbody>
                <tr id="Höfuðborgarsvæði">
                    <td scope="row">Höfuðborgarsvæði</th>
                    <td>Reykjavík</td>
                    <td>213 619</td>
                    <td>1 062</td>
                </tr>
    ...
    $("#mapa-island path").on('click', function () {
        ...
        if ($(this).hasClass('clicked')) {
            ...
            $('#info').fadeOut(50, function () {
                $('#info').html(`<h4 class="mt-3 pl-2 d-inline-block">${mesto.city} <small class="text-small">${new Intl.NumberFormat('cs-CS').format(mesto.peoples)} obv.</small></h4>
                ...
                <div class="mt-3">${mesto.text}</div>
                <div class=""><img src="img/${mesto.sign}.svg" class="img-fluid"></div>`)
            });
            $('#info').fadeIn(200);
        }
